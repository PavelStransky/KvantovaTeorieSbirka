...
\begin{solution}
    ...
    \begin{subequations}
        \begin{align}
            S_{2lm,100}\hi{0}(t)&=0,\\
            S_{2lm,100}\hi{1}(t)&=-\frac{\im}{\hbar}\int_{0}^{t}\matrixelement{2,l,m}{\left[-qE(t_{1})\operator{z}\right]}{1,0,0}\e^{\im\omega_{21}t_{1}}\d t_{1},
            \label{eq:SH2lm}
        \end{align}            
    \end{subequations}
    kde
    ...
    \begin{align}
        S_{210,100}\hi{1}(t)
            ...
            &=-\frac{\im}{\hbar}\frac{4^{4}eE_{0}a_{0}}{3^{5}\sqrt{2}}\frac{\tau}{\im\omega_{21}\tau-1}\left(\e^{-\frac{t}{\tau}+\im\omega_{21}t}-1\right).
    \end{align}
