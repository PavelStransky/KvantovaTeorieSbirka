...
\begin{solution}
	...
	\item
		...
		\begin{equation}
			\mathcal{P}_{0\rightarrow1}=\abs{S_{10}^{(0)}+S_{10}^{(1)}}^{2}=\frac{q^{2}A^{2}}{2\hbar M\Omega}\e^{-\frac{\Omega^{2}\tau^{2}}{2}}=\frac{P^{2}}{2\hbar M\Omega}\e^{-\frac{\Omega^{2}\tau^{2}}{2}}\,.
		\end{equation}	
	\end{enumerate}
