	...
	\begin{align}
		E_{0,S=1}^{\ti{F}(1)}
			...
			&=\frac{v}{\pi}\left(\frac{M\Omega}{\hbar}\right)^{2}
				...
				\frac{1}{2}\frac{1}{\frac{M\Omega}{2\hbar}+\alpha}
				\sqrt{\frac{\pi}{\frac{M\Omega}{2\hbar}+\alpha}}=\nonumber\\
			&=v\left(\frac{M\Omega}{M\Omega+2\hbar\alpha}\right)^{3/2}.
	\end{align}
\end{solution}
