...
\begin{solution}
	...
	\begin{equation}\label{eq:IdenticalBosonsWaveFunction}
		\psi_{0}^{\ti{B}}(x_{1},x_{2})
			...
			=\sqrt{\frac{M\Omega}{\pi\hbar}}\e^{-\frac{M\Omega}{2\hbar}\left(x_{1}^{2}+x_{2}^{2}\right)}
	\end{equation}			
	...
	\begin{align}
		E_{0}^{\ti{B}(1)}
			...
			&=v\frac{M\Omega}{\pi\hbar}\iint\e^{-\frac{M\Omega}{\hbar}\left(x_{1}^{2}+x_{2}^{2}\right)}
				\e^{-\alpha\left(x_{1}-x_{2}\right)^{2}}\d x_{1}\d x_{2}=\nonumber\\
			&=v\frac{M\Omega}{\pi\hbar}\iint\e^{-\frac{M\Omega}{2\hbar}
			...
			&=v\frac{M\Omega}{\pi\hbar}\int\e^{-\frac{2M\Omega}{\hbar}X^{2}}\d X
				\int\e^{-\left(\frac{M\Omega}{2\hbar}+\alpha\right)x^{2}}\d x=\nonumber\\
			&=v\frac{M\Omega}{\pi\hbar}\sqrt{\frac{\pi\hbar}{2M\Omega}}
				\sqrt{\frac{\pi}{\frac{M\Omega}{2\hbar}+\alpha}}=\nonumber\\
			&=v\sqrt{\frac{M\Omega}{M\Omega+2\hbar\alpha}}.
	\end{align} 
\end{solution}
