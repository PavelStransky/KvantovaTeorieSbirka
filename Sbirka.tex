...
% 0 pro verzi bez řešení DÚ
% 1 pro verzi s řešením DÚ
\def\fullversion{0}

\ifthenelse{\equal{\fullversion}{0}}
	{\excludecomment{homeworknote}}
	{\includecomment{homeworknote}}

\includecomment{theory}

% Toto se odkomentuje pro tištěnou kompletní sbírku
\excludecomment{homework}
%\includecomment{homework}
...
\newcommand{\exercise}[2][]{\ifthenelse{\isempty{#1}}
	...
	{\np\thispagestyle{empty}\subsubsection*{Domácí úkol -- #2 \small{\it{(termín odevzdání: {#1})}}}}
}
...
%\input{DeltaFunkce/DeltaFunkce2}\np
