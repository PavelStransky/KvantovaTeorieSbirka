...
%\filecopy{D:/Pavel/Obsidian/Physics/Literature/References.bib}{Global.bib}

\usepackage[sorting=none,style=phys]{biblatex}
\addbibresource{Global.bib}
\addbibresource{References.bib}
% \addbibresource{D:/Pavel/Obsidian/Physics/Literature/References.bib}
...
% Oliver Křenek, Lukáš Frk, Tomáš Tuleja
...
Sbírka včetně všech doprovodných materiálů je dostupná ve veřejném repozitáři na adrese \url{https://github.com/PavelStransky/Sbirka}.
\np
...
\input{KvantovePocitani/KvantovePocitani}\np
