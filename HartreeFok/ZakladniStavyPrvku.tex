...
V ní je jednočásticová část Hartree-Fockovy rovnice diagonální,
\begin{align}
...
\begin{enumerate}
    ...
    \item Porovnejte získané energie s přesnými hodnotami (v atomových jednotkách)
        ...
        \end{equation*}
        Výsledek podle Hartreeho a Focka by neměl být moc mimo.
    \end{enumerate}

    Toto je esence Hartree-Fockovy metody, která se používá v jaderné, atomové i molekulové fyzice.
...
\begin{solution}
    ...
    Pro explicitní výpočet maticových elementů $\matrixelement{ab}{\operator{v}^{(2)}}{cd}$ lze využít například program Wolfram Mathematica. 
    Použitý kód \href{https://github.com/PavelStransky/KvantovaTeorieSbirka/blob/sbirka/codes/hartree\%20fock/RadialIntegral.nb}{RadialIntegral.nb} je v repozitáři v adresáři \href{https://github.com/PavelStransky/KvantovaTeorieSbirka/tree/sbirka/codes/hartree\%20fock}{codes/hartree fock}.
    Vypočítané maticové elementy pro $n_\mathrm{max}=4$ jsou v souboru \href{https://github.com/PavelStransky/KvantovaTeorieSbirka/blob/sbirka/codes/hartree\%20fock/radial.txt}{radial.txt}.
    ...
    Kód napsaný v jazyce Python počítající energii základního stavu jednoduchých atomů najdete rovněž v repozitáři na 
    \href{https://github.com/PavelStransky/KvantovaTeorieSbirka/blob/sbirka/codes/hartree\%20fock/hf.py}{hf.py}.
\end{solution}
