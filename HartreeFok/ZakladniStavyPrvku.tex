...
\begin{solution}
    ...
    Použitý kód \href{https://github.com/PavelStransky/KvantovaTeorieSbirka/blob/sbirka/codes/hartree_fock/RadialIntegral.nb}{RadialIntegral.nb} je v repozitáři v adresáři \href{https://github.com/PavelStransky/KvantovaTeorieSbirka/tree/sbirka/codes/hartree_fock}{codes/hartree fock}.
    Vypočítané maticové elementy pro $n_\mathrm{max}=4$ jsou v souboru \href{https://github.com/PavelStransky/KvantovaTeorieSbirka/blob/sbirka/codes/hartree_fock/radial.txt}{radial.txt}.
    ...
    \href{https://github.com/PavelStransky/KvantovaTeorieSbirka/blob/sbirka/codes/hartree_fock/hf.py}{hf.py}.
\end{solution}
