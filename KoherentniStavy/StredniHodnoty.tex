...
\begin{solution}
	...
	\item
		...
		\begin{note}
			Ze srovnání výsledků tohoto bodu se vztahy~\eqref{eq:HOCoherentStateFromPositionMomentum} a~\eqref{eq:HOCoherentStateab} vyplývá, že koherentní stav $\ket{z}$ lze interpretovat (až na fázi) jako základní stav harmonického oscilátoru posunutého v souřadnici o $a=\mean{\operator{x}}_{z}$ a v hybnosti o $b=\mean{\operator{p}}_{z}$. V $x$-reprezentaci ho lze vyjádřit jako posunutou Gaussovskou funkci~\eqref{eq:HOWaveFunctionGroundState}.
		\end{note}
