...
\end{equation}
(plyne z volby $\ket{j_{1}\,j_{1}}\ket{0\,0}=\ket{j_{1}\,j_{1}\,0\,0}$, 
...
\begin{solution}
	Speciální případ vztahu mezi Clebsch-Gordanovými koeficienty a $3j$ symboly~\eqref{eq:3j3} dá
	\begin{align}
    ...
    \begin{subequations}
        \begin{align}
            \clebsch{0}{0}{j}{m}{J}{M}
                &=\clebsch{j}{m}{0}{0}{J}{M}=\delta_{jJ}\delta_{mM},\\
            \clebsch{J}{-M}{j}{m}{0}{0}
                &=(-1)^{j-J}\frac{(-1)^{j+M}}{\sqrt{2J+1}}\clebsch{j}{m}{0}{0}{J}{M}
