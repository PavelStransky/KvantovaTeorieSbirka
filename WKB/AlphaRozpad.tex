...
\begin{solution}
	...
	\item
		...
		\begin{align}
			\psi_{\mathrm{I}}(x)
				...
				&=\underbrace{-\im C\left(\frac{1}{F}-\frac{F}{4}\right)\e^{\im\frac{\pi}{4}}}_{A}\frac{1}{\sqrt{\abs{p(x)}}}\e^{\im I_{x}^{a}}
	...
	\begin{note}
		...
		\end{equation}
		která se nazývá \emph{Geigerova-Nuttallova závislost}~\cite{Geiger1911} a ve které se konstanty $C_{1,ě}$ a $\zeta$ určují z experimentu.
	\end{note}
\end{solution}
