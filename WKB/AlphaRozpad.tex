...
\begin{solution}
	...
	\item
		...
		\begin{align}
			\psi_{\mathrm{I}}(x)
				&=\frac{2\lambda}{F}\sin\left[I_{x}^{a}+\frac{\pi}{4}\right]+\frac{\im}{2}\lambda F\cos\left[I_{x}^{a}+\frac{\pi}{4}\right]\nonumber\\										
				&=\underbrace{-\im \mathcal{C}\left(\frac{1}{F}-\frac{F}{4}\right)\e^{\im\frac{\pi}{4}}}_{\mathcal{A}}\frac{1}{\sqrt{\abs{p(x)}}}\e^{\im I_{x}^{a}}
					+\underbrace{\im \mathcal{C}\left(\frac{1}{F}+\frac{F}{4}\right)\e^{-\im\frac{\pi}{4}}}_{\mathcal{B}}\frac{1}{\sqrt{\abs{p(x)}}}\e^{-\im I_{x}^{a}}.						
		\end{align}
		Transmisní koeficient tedy vychází
		\begin{equation}
			T=\abs{\frac{\mathcal{C}}{\mathcal{A}}}^{2}=\frac{1}{\left(\frac{1}{F}-\frac{F}{4}\right)^{2}}\approx F^{2}\,,
		\end{equation}
		...
		Dosazení za $F$ dá hledaný Gamovův faktor~\eqref{eq:Gammov}.
