...
\end{equation}
kde $x_{0}$ je libovolný bod, od kterého se integruje (změna integrační meze $x_0$ pouze změní fázi vlnové funkce) a $C,D$ jsou amplitudy obou komponent odpovídajícím vlně pohybující se podél osy $x$ a proti ose $x$ (amplitudy mohou být komplexní).
