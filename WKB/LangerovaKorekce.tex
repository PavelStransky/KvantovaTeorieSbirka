\subsection{Coulombické pole}	
    ...
    aplikujeme-li tzv. \emph{Langerovu korekci}\footnote{
        Langerova korence odvozuje z asymptotiky vlnových funkcí~\cite{Langer1937}.
    }\index{korekce!Langerova}, která spočívá v nahrazení 
    \begin{equation}
        \important{l(l+1)\rightarrow\left(l+\frac{1}{2}\right)^{2}}
    \end{equation}
    .
    Vázané stavy lze pak nalézt z rovnice ekvivalentní Bohrově-Sommerfeldově kvantovací podmínce\index{podmínka!Bohrova-Sommerfeldova kvantovací}
    \begin{equation}
    ...
    \begin{enumerate}
        ...
        \item 
            Pomocí WKB přiblížení nalezněte diskrétní spektrum, tj. stavy s energií $E<0$.
