...
\item
    ...
    \begin{subequations}
        \begin{align}
            \psi_{\mathrm{II}_{1}^{+}}(x)&=\frac{\mathcal{A}_{+}}{\sqrt{\abs{p(x)}}}\e^{\frac{1}{\hbar}\int_{x}^{x_{1}}\abs{p(x')}\d x'},\\
            \psi_{\mathrm{I}_{1}^{+}}(x)&=-\frac{2\mathcal{A}_{+}}{\sqrt{\abs{p(x)}}}\sin\left[\frac{1}{\hbar}\int_{x_{1}}^{x}p(x')\d x'-\frac{\pi}{4}\right]
        \end{align}            
    ...
    \begin{subequations}
        \begin{align}
            \psi_{\mathrm{II}_{1}^{-}}(x)&=\frac{\mathcal{A}_{-}}{\sqrt{\abs{p(x)}}}\e^{-\frac{1}{\hbar}\int_{x}^{x_{1}}\abs{p(x')}\d x'},\\
            \psi_{\mathrm{I}_{1}^{-}}(x)&=\frac{\mathcal{A}_{-}}{\sqrt{\abs{p(x)}}}\cos\left[\frac{1}{\hbar}\int_{x_{1}}^{x}p(x')\d x'-\frac{\pi}{4}\right],
        \end{align}		            
    ...
    Vlnová funkce $\psi_{\mathrm{II}_{1}^{-}}$ klesá exponenciálně pro $x\rightarrow-\infty$, zatímco $\psi_{\mathrm{II}_{1}^{+}}$ exponenciálně diverguje.
...
\item
    ...
    \begin{subequations}
        \begin{align}
            \psi_{\mathrm{I}_{2}^{-}}(x)&=\frac{2\mathcal{B}_{-}}{\sqrt{\abs{p(x)}}}\sin\left[\frac{1}{\hbar}\int_{x}^{x_{2}}p(x')\d x'+\frac{\pi}{4}\right],\\
            \psi_{\mathrm{II}_{2}^{-}}(x)&=\frac{\mathcal{B}_{-}}{\sqrt{\abs{p(x)}}}\e^{-\frac{1}{\hbar}\int_{x_{2}}^{x}\abs{p(x')}\d x'}\,,
        \end{align}            
    ...
    \begin{subequations}
        \begin{align}
            \psi_{\mathrm{I}_{2}^{+}}(x)&=\frac{\mathcal{B}_{+}}{\sqrt{\abs{p(x)}}}\cos\left[\frac{1}{\hbar}\int_{x}^{x_{2}}p(x')\d x'+\frac{\pi}{4}\right],\\
            \psi_{\mathrm{II}_{2}^{+}}(x)&=\frac{\mathcal{B}_{+}}{\sqrt{\abs{p(x)}}}\e^{\frac{1}{\hbar}\int_{x_{2}}^{x}\abs{p(x')}\d x'},
        \end{align}            
...
\sec{Kvadratické navazovací podmínky}
	V případě kvadratické bariéry lze navazující podmínky před a po bariéře vyjádřit například v tomto tvaru~\cite{Berry1972}:
    \begin{subequations}
        \begin{align}
            \psi_{\mathrm{I}}(x)
                &=\mathcal{C}\frac{\e^{-\pi\epsilon}}{\sqrt{p(x)}}
                \e^{\pm\frac{\im}{\hbar}\int_{x}^{a}p(x')\d x'\mp\im\frac{\pi}{4}}
                +\mathcal{C}\frac{\sqrt{1+\e^{-2\pi\epsilon}}}{\sqrt{p(x)}}
                \e^{\mp\frac{\im}{\hbar}\int_{x}^{a}p(x')\d x'\pm\im\frac{\pi}{4}}\e^{\pm\im\phi(\epsilon)},\\
            \psi_{\mathrm{II}}(x)
                &=\frac{\mathcal{C}}{\sqrt{p(x)}}
