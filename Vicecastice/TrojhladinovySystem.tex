\subsection{Trojhladinový systém}
    ...
    \begin{enumerate}
        ...
        \item
            Jaký je překryv stavu odpovídajícího nižšímu vlastnímu stavu Hamiltoniánu $\operator{H}$ s dvoučásticovým stavem popisujícím dvě částice na hladině $h=2$?\footnote{
