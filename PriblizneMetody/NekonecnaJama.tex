	...
	\item
		...
		\begin{align}
			\bar{H}(\lambda)
				...
				&=\frac{\hbar^{2}}{2m}\,\lambda(\lambda-1)
					\frac{\left[\frac{1}{\lambda-1}a^{\lambda}x^{\lambda-1}-\frac{1}{2\lambda-1}x^{2\lambda-1}\right]_{0}^{a}}
					{\left[a^{2\lambda}x-\frac{2}{\lambda+1}a^{\lambda}x^{\lambda+1}+\frac{1}{2\lambda+1}x^{2\lambda+1}\right]_{0}^{a}}=\nonumber\\
