...
\begin{theory}   
    ...
    Upouští se od normalizace vektorů $\ket{\chi_{m}^{\hi{n}}}$, avšak požaduje se
    \begin{equation}
        \braket{\phi_{m}}{\chi_{l}(\lambda)}=\delta_{ml}.
    \end{equation}
...
\input{PriblizneMetody/HarmonickyOscilator.tex}
\input{PriblizneMetody/VanDerWaals.tex}
